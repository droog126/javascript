...
Array.prototype._map=function(func,this_arr){
    
    let rr=this.reduce((prv_r,val,index,source)=>{
        prv_r.constructor==Array ? prv_r : prv_r=[val]

        let r=func.call(this_arr,val,index)
        prv_r.push(r);
        return prv_r;
    })
    return rr;
